...
// Consulta SQL para obtener los reportes obsoletos
$sqlReports = "SELECT r.id_report_type, r.name, r.description, r.date, rt.name AS rt 
               ...
               WHERE r.state_report = 0"; // Solo selecciona reportes obsoletos
...
$sheet->setCellValue('A1', 'Informe de Reportes Obsoletos en ' . $fecha . ' a las ' . $hora);
...
$nombreArchivo = "Reportes Obsoletos - ARKOVA en $fechaHora.xlsx";
...
$sql_aud = "INSERT INTO auditory (aud_user, aud_registereddate, aud_action) VALUES ('$username', '$fecha', 'El usuario [$username] generó un informe de los Reportes Obsoletos en formato Excel')";
