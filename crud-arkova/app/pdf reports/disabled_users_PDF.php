...
$sqlUsers = "SELECT user_name, names, last_names, identity_card, email, 
                    ...
                    END AS role
             FROM users
             WHERE state_user = 0"; // Solo selecciona usuarios inactivos
...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Write(5, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', '| Informe de Usuarios Inhabilitados en ' . $fecha . ' a las ' . $hora));
        $this->Ln(20);
...
$nombreArchivo = "Usuarios Inhabilitados - ARKOVA en " . $fechaHora . ".pdf";
...
$sql_aud = "INSERT INTO auditory (aud_user, aud_registereddate, aud_action) VALUES ('$username', '$fecha', 'El usuario [$username] generó un informe de Usuarios Inhabilitados en formato PDF')";
