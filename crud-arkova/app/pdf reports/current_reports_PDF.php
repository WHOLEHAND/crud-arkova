...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Write(5, iconv('UTF-8', 'ISO-8859-1//TRANSLIT', '| Informe de Reportes Vigentes en ' . $fecha . ' a las ' . $hora));
        $this->Ln(20);
...
$nombreArchivo = "Reportes Vigentes - ARKOVA en " . $fechaHora . ".pdf";
...
$sql_aud = "INSERT INTO auditory (aud_user, aud_registereddate, aud_action) VALUES ('$username', '$fecha', 'El usuario [$username] generó un informe de los Reportes Vigentes en formato PDF')";
