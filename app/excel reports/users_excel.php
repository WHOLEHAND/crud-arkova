...
$sheet->setCellValue('A1', 'Informe de Usuarios Activos en ' . $fecha . ' a las ' . $hora);
...
$filename = 'Usuarios_Activos_ARKOVA_' . date("d-m-Y_H-i-s") . '.xlsx';
...
$sql_aud = "INSERT INTO auditory (aud_user, aud_registereddate, aud_action) VALUES ('$username', '$fecha', 'El usuario [$username] generó un informe de Usuarios Activos en formato Excel')";
